...
{{--                ?>--}}
        ...
        @if($windowHandler->windowHandler && $windowHandler->windowHandler->price > 0 && $windowHandler->total_window_handler_quantity > 0)
                <tr class="list-item">
                    ...
                    <th class="list-text1">{{($windowHandler->windowHandler->orderDetail->handlerPositionType)?$windowHandler->windowHandler->orderDetail->handlerPositionType->handler_type_name:""." "}}{{($windowHandler->windowHandler) ? $windowHandler->windowHandler->name:"" . " "}} {{$windowHandler->windowHandler->orderDetail->handlerPosition->name}}</th>
