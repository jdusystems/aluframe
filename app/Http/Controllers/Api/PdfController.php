    ...
    public function orderDetails(GetOrderDetailRequest $request){
        ...
        foreach ($details as $detail){
            ...
            $data[] = [
                ...
                'window_handler_name' => ($windowHandler1) ? $windowHandler1->profileType->name .','. $windowHandler1->profileColor->name . ',' . $handlerPositionType->handler_type_name .','. $handlerPosition->name  : "",
                'window_handler_name_uz' => ($windowHandler1) ? $windowHandler1->profileType->uz_name .','. $windowHandler1->profileColor->uz_name . ',' . $handlerPositionType->handler_type_name_uz .','. $handlerPosition->uz_name  : "",
